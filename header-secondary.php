        ...
        <header>
            <nav id="dropNav">
                ...
                <div class="dropNav-items">
                    <a href='index.php?page_id=129' alt="Link para a home">Home</a>
                    <hr>
                    <a href='index.php?page_id=30' alt="Link para nossa história">Institucional</a>
                    <hr>
                    <a href='index.php?page_id=226' alt="Link para nossos empreendimentos">Empreendimentos</a>
                    <hr>
                    <a href="index.php?page_id=220" alt="Link para entrar em contato">
                        Contato
                    </a>
                </div>
            </nav>
